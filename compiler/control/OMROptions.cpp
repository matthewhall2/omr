...
TR::OptionTable OMR::Options::_jitOptions[] = {
    ...
    { "disableTrivialDeadStoreElimination", "O\tdisable trivial dead store elimination",
     TR::Options::disableOptimization, trivialDeadStoreElimination, 0, "P" },
    ...
    { "disableUseDefBasedVectorAPIExpansion", "M\tdisable UseDef-based VectorAPIExpansion",
     RESET_OPTION_BIT(TR_EnableUseDefBasedVectorAPIExpansion), "F" },
    ...
    { "enableUseDefBasedVectorAPIExpansion", "M\tenable UseDef-based VectorAPIExpansion",
     SET_OPTION_BIT(TR_EnableUseDefBasedVectorAPIExpansion), "F" },
    ...
    { "traceTrivialBlockExtension", "L\ttrace trivial block extension", TR::Options::traceOptimization,
     trivialBlockExtension, 0, "P" },
    { "traceTrivialDeadStoreElimination", "L\ttrace trivial dead store elimination", TR::Options::traceOptimization,
     trivialDeadStoreElimination, 0, "P" },
