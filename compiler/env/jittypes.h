...
typedef struct TR_ByteCodeInfo {
    ...
    void setInvalidByteCodeIndex() { setByteCodeIndex(invalidByteCodeIndex); }

    void setZeroByteCodeIndex() { setByteCodeIndex(0); }

    bool isInvalidByteCodeIndex() { return getByteCodeIndex() == invalidByteCodeIndex; }

    void setInvalidCallerIndex() { setCallerIndex(invalidCallerIndex); }
...
private:
    ...
    uint32_t _byteCodeIndex: 17; /* should not be less than jitConfig->bcSizeLimit, currently is 64k (16 bits) */
