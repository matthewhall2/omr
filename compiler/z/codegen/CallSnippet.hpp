...
public:
    ...
    static uint8_t *printS390ArgumentsFlush(OMR::Logger *log, TR::Node *node, uint8_t *bufferPos, int32_t argSize, TR_Debug *debug, int32_t argStart, TR::Machine *machine, TR::Linkage *privateLinkage);
};
