 ...
 */
#define ANYREGINDEX(i)                                                                       \
    ((i >= TR::RealRegister::FirstFPR)                                                       \
            ? ((i >= TR::RealRegister::FirstAssignableVRF) ? VRFREGINDEX(i) : FPREGINDEX(i)) \
            : REGINDEX(i))
...
public:
    ...
    virtual void *saveArguments(void *cursor, bool genBinary, bool InPreProlog = false, int32_t frameOffset = 0,
        List<TR::ParameterSymbol> *parameterList = NULL);
...
public:
    ...
    TR::Register *pushLongArg32(TR::Node *callNode, TR::Node *child, int32_t numIntegerArgs, int32_t numFloatArgs,
        int32_t *stackOffsetPtr, TR::RegisterDependencyConditions *dependencies, TR::Register *argRegister = NULL);
    TR::Register *pushArg(TR::Node *callNode, TR::Node *child, int32_t numIntegerArgs, int32_t numFloatArgs,
        int32_t *stackOffsetPtr, TR::RegisterDependencyConditions *dependencies, TR::Register *argRegister = NULL);
    TR::Register *pushAggregateArg(TR::Node *callNode, TR::Node *child, int32_t numIntegerArgs, int32_t numFloatArgs,
        int32_t *stackOffsetPtr, TR::RegisterDependencyConditions *dependencies, TR::Register *argRegister = NULL);
    TR::Register *pushJNIReferenceArg(TR::Node *callNode, TR::Node *child, int32_t numIntegerArgs, int32_t numFloatArgs,
        int32_t *stackOffsetPtr, TR::RegisterDependencyConditions *dependencies, TR::Register *argRegister = NULL);
    ...
    void loadIntArgumentsFromStack(TR::Node *callNode, TR::RegisterDependencyConditions *dependencies,
        TR::DataType argType, int32_t stackOffset, int32_t argsSize, int32_t numIntegerArgs,
        TR::Register *stackRegister);
    ...
    int64_t killAndAssignRegister(int64_t killMask, TR::RegisterDependencyConditions *deps, TR::Register **virtualReg,
        TR::RealRegister::RegNum regNum, TR::CodeGenerator *cg, bool isAllocate = false, bool isDummy = false);

    int64_t killAndAssignRegister(int64_t killMask, TR::RegisterDependencyConditions *deps, TR::Register **virtualReg,
        TR::RealRegister *realReg, TR::CodeGenerator *cg, bool isAllocate = false, bool isDummy = false);
    ...
    int32_t setRegisterFlag(TR::RealRegister::RegNum regNum, int32_t regFlag)
    {
        return _registerFlags[regNum] |= regFlag;
    }

    int32_t setRegisterFlags(TR::RealRegister::RegNum regNum, int32_t regFlags)
    {
        return _registerFlags[regNum] = regFlags;
    }

    int32_t resetRegisterFlags(TR::RealRegister::RegNum regNum, int32_t regFlags)
    {
        return _registerFlags[regNum] &= ~regFlags;
    }
    ...
    uint32_t getIntegerArgumentAddToPost(TR::RealRegister::RegNum regNum)
    {
        return _registerFlags[regNum] & IntegerArgumentAddToPost;
    }

    void clearIntegerArgumentAddToPost(TR::RealRegister::RegNum regNum)
    {
        _registerFlags[regNum] &= ~IntegerArgumentAddToPost;
    }
    ...
    virtual TR::RealRegister::RegNum getIntegerArgumentRegister(uint32_t index)
    {
    ...
    virtual TR::RealRegister::RegNum getFloatArgumentRegister(uint32_t index)
    {
    ...
    virtual TR::RealRegister::RegNum getVectorArgumentRegister(uint32_t index)
    {
    ...
    // Special Registers
    virtual TR::RealRegister::RegNum setStackPointerRegister(TR::RealRegister::RegNum r)
    {
        return _stackPointerRegister = r;
    }
    ...
    virtual TR::RealRegister::RegNum setStackPointerRegister(uint32_t num, TR::RealRegister::RegNum r)
    {
        return _stackPointerRegister = r;
    }
    ...
    virtual TR::RealRegister::RegNum setEntryPointRegister(TR::RealRegister::RegNum r)
    {
        return _entryPointRegister = r;
    }
    ...
    virtual TR::RealRegister::RegNum setStaticBaseRegister(TR::RealRegister::RegNum r)
    {
        return _staticBaseRegister = r;
    }
    ...
    virtual TR::RealRegister::RegNum setPrivateStaticBaseRegister(TR::RealRegister::RegNum r)
    {
        return _privateStaticBaseRegister = r;
    }
    ...
    virtual TR::RealRegister::RegNum setVTableIndexArgumentRegister(TR::RealRegister::RegNum r)
    {
        return _vtableIndexArgumentRegister = r;
    }
    ...
    virtual TR::RealRegister::RegNum setJ9MethodArgumentRegister(TR::RealRegister::RegNum r)
    {
        return _j9methodArgumentRegister = r;
    }
...
protected:
    ...
    TR::Instruction *restorePreservedRegs(TR::RealRegister::RegNum, TR::RealRegister::RegNum, int32_t,
        TR::Instruction *, TR::Node *, TR::RealRegister *, TR::MemoryReference *, TR::RealRegister::RegNum);
